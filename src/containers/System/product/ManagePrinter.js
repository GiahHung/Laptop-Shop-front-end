...
class ManagePrinter extends Component {
  constructor(props) {
    super(props);
    this.state = {
      arrStatus: [],
...
const mapStateToProps = (state) => {
  return {
    ...
    brandIds: state.admin.printBrandIds,
...
const mapDispatchToProps = (dispatch) => {
  return {
    fetchPrintBrand: () => dispatch(actions.fetchPrintBrand()),
...
export default connect(mapStateToProps, mapDispatchToProps)(ManagePrinter);
